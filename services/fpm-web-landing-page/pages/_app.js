		...
		<ThemeProvider theme={theme}>
			<Head>
				...
				<meta
					property="og:image"
					itemProp="image"
					content={`/static/screenshots/main.jpg`}
				/>
				<meta property="og:url" content="https://friendsplus.me" />
				<meta
					property="og:title"
					itemProp="name"
					content="Friends+Me - Share to ANYWHERE. Because sharing is caring."
				/>
				<meta
				...
				<meta
					name="keywords"
					content="Google, Google+, queue, broadcast, repost, cross-post, cross-promote, promote, connect, Facebook, Twitter, Linkedin, Tumblr, Pinterest"
				/>
				...
				<script
					dangerouslySetInnerHTML={{
						__html:
							'(function(d) {var config={kitId:"pba0mdo",scriptTimeout:3000,async:true},h=d.documentElement,t=setTimeout(function(){h.className=h.className.replace(/\bwf-loading\b/g,"")+" wf-inactive";},config.scriptTimeout),tk=d.createElement("script"),f=false,s=d.getElementsByTagName("script")[0],a;h.className+=" wf-loading";tk.src=\'https://use.typekit.net/\'+config.kitId+\'.js\';tk.async=true;tk.onload=tk.onreadystatechange=function(){a=this.readyState;if(f||a&&a!="complete"&&a!="loaded")return;f=true;clearTimeout(t);try{Typekit.load(config)}catch(e){}};s.parentNode.insertBefore(tk,s)})(document);',
					}}
				/>
				{process.env.NODE_ENV === "production" && (
					<script
						dangerouslySetInnerHTML={{
							...
							}.js','ga');ga('create', 'UA-XXX-11', 'auto');`,
						}}
					/>
				)}
				{process.env.NODE_ENV === "production" && (

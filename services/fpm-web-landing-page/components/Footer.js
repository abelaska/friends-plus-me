...
const FooterMenu = styled(Row)`padding-top: 20px;`;

const Menu = styled(Row)`height: 50px;`;
      ...
      <FooterInner>
        ...
        <FooterMenu>
          <Col xs={12} sm={true} md={true} lg={true}>
            ...
            <FooterLink href="/wall-of-love">Wall of Love</FooterLink>
          </Col>
          <Col xs={12} sm={true} md={true} lg={true}>
            <FooterLink href="/about">About</FooterLink>
            <FooterLink href="https://developers.friendsplus.me">Developers</FooterLink>
          ...
          <Col xs={12} sm={true} md={true} lg={true}>
            <FooterLink href="http://friendsplus.me/privacy">Privacy</FooterLink>
            <FooterLink href="/tos">Terms</FooterLink>
          </Col>
        </FooterMenu>

        <FooterCopyright>
          <Col xs={12}>Copyright &copy; {new Date().getFullYear()} Loysoft Limited, All rights reserved.</Col>
        </FooterCopyright>
      </FooterInner>
    </Footer>
  </ThemeProvider>

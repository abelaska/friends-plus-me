    ...
    .directive('datetimepicker', ['$log', 'dateTimePickerConfig', function datetimepickerDirective($log, defaultConfig) {
      ...
      return {
        ...
        link: function link(scope, element, attrs, ngModelController) {
          ...
          var dataFactory = {
            year: function year(unixDate, unixNow) {
              var now = moment.utc(unixNow).startOf('year');
              ...
              for (var i = 0; i < 12; i += 1) {
                ...
                var dateValue = {
                  ...
                  'selectable': yearMoment.isBefore(now) ? false : true
                };
            ...
            month: function month(unixDate, unixNow) {
              var now = moment.utc(unixNow).startOf('month');
              ...
              for (var i = 0; i < 12; i += 1) {
                ...
                var dateValue = {
                  ...
                  'selectable': monthMoment.isBefore(now) ? false : true
                };
            ...
            day: function day(unixDate, unixNow) {
              var now = moment.utc(unixNow).startOf('day');
            ...
            hour: function hour(unixDate, unixNow) {
              var now = moment.utc(unixNow).startOf('hour');
              ...
              for (var i = 0; i < 24; i += 1) {
                ...
                var dateValue = {
                  ...
                  'selectable': hourMoment.isBefore(now) ? false : true
                };
            ...
            minute: function minute(unixDate, unixNow) {
              var now = moment.utc(unixNow).startOf('minute');
          ...
          scope.changeView = function changeView(viewName, dateObject, event) {
            ...
            if (viewName && (dateObject.dateValue > -Infinity) && dateObject.selectable && dataFactory[viewName]) {
              var now = getUTCTime(),
                  result = dataFactory[viewName](dateObject.dateValue, now);
